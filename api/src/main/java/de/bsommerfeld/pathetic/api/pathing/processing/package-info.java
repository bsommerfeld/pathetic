 ...
 *
 * <ul>
 *   <li><b>Node Validation ({@link de.bsommerfeld.pathetic.api.pathing.processing.NodeValidationProcessor}):</b>
 ...
 *       de.bsommerfeld.pathetic.api.pathing.processing.NodeCostProcessor}):</b> Modifying the cost of
 ...
 * de.bsommerfeld.pathetic.api.pathing.processing.Processor}) and are provided with contextual information
 * for the current search ({@link de.bsommerfeld.pathetic.api.pathing.processing.context.SearchContext}) and
