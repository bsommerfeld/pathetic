 ...
 * processor lifecycle methods (e.g., {@link Processor#initializeSearch(SearchContext)})
 * and is accessible via the {@link NodeEvaluationContext}.
 */
public interface SearchContext {
   ...
   * Processors can use this to access settings like heuristic weights,
   * max length, etc.
   *
   ...
   * Processors can use this to query intrinsic properties of PathPositions
   * or the environment, aiding in validation or cost calculation.
   * This is crucial for understanding traversability or terrain types.
   *
  ...
  /**
   * Returns a mutable map that can be used by {@link Processor}s to share data
   * throughout the lifecycle of this search operation.
   * This map is initialized once per search.
   *
